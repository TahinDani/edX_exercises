...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        for i in lower_letters:
            shifted_dict[i] = lower_letters[(lower_letters.index(i) + shift) % 26]
        for i in upper_letters:
            shifted_dict[i] = upper_letters[(upper_letters.index(i) + shift) % 26]
        return shifted_dict
    ...
    def apply_shift(self, shift):
        ...
        for i in self.message_text:
            if i in string.ascii_letters:
                encrypted_message += shifted_dict[i]
            else:
                encrypted_message += i
...
class CiphertextMessage(Message):
    ...
    def decrypt_message(self):
        ...
        for i in range(1, 27):
            valid_count = 0
            shifted_text = super(CiphertextMessage, self).apply_shift(i)
            ...
            for word in words:
                if is_word(self.valid_words, word):
                    ...
                    if valid_count > max_valid_words:
                        ...
                        shift_count = i if i < 26 else 0
        return (shift_count, super(CiphertextMessage, self).apply_shift(shift_count))
